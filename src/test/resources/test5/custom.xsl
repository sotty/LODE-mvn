<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="owl:Class" priority="1">
        <div id="{generate-id()}" class="entity">
            ...
            <xsl:call-template name="get.class.defs" />
            <xsl:call-template name="get.class.description" />
            <xsl:call-template name="get.class.info" />
            <xsl:call-template name="get.class.examples" />
        </div>
    </xsl:template>

    <xsl:template name="get.class.defs">
    ...
    <xsl:template name="get.class.info">
    ...
    <xsl:template name="get.class.examples">
